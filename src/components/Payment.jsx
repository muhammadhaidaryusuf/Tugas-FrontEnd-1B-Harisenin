...
const Payment = () => {
  ...
  const iconCard = [{ path: "/img/componen-img/visa-logo.png" }, { path: "/img/componen-img/MASTERCARD.png" }, { path: "/img/componen-img/jcb.png" }, { path: "/img/componen-img/AMERICAN EXPRESS.png" }];
