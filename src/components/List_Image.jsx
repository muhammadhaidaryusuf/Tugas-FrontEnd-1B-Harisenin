          ...
          <div className="grid grid-cols-3  md:grid-cols-6 gap-2 ">
            {(showAll ? items : items.slice(0, 6)).map((item, index) => (
              <div key={index} className="carousel-item relative">
                ...
                {/* btn hapus */}
                <button
                  className="absolute right-[-0.10rem] top-[-0.9rem] bg-transparent border text-white text-[10px] w-[1rem] justify-center items-center rounded-full hover:bg-red-800 transition"
