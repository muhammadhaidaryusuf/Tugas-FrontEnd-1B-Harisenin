  ...
  return (
    <div className="paket-choice">
      ...
      <div className="flex flex-col sm:flex-row gap-1  sm:gap-6 justify-center items-center">
        ...
        <Card type="Berdua" price="Mulai dari Rp79,990/bulan" description="2 Akun" features={["Tidak ada iklan", "Kualitas 1080p", "Download konten pilihan"]} buttonLabel="Langganan" onButtonClick={() => alert("Berlangganan Berdua!")} />

        <Card type="Keluarga" price="Mulai dari Rp159,990/bulan" description="5-7 Akun" features={["Tidak ada iklan", "Kualitas 4k", "Download konten pilihan"]} buttonLabel="Langganan" onButtonClick={() => alert("Berlangganan Family!")} />
      </div>
    </div>
  );
};
